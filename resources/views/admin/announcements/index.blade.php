...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row my-3">
            <div class="col-6">
                <a href="{{route('announcements.create')}}"  class="btn btn-primary">اعلان جديد</a>
            </div>
        </div>
        ...
        $(document).ready(function () {
            ...
            $("#datatable").DataTable({
                ...
                columns: [
                    ...
                    {data: 'expiry_date', name: 'expiry_date' , title: 'تاريخ الانتهاء', orderable: false, searchable: false},
...
@include('includes.delete_item',['route_delete'=>url("/panel/announcements")])
@endsection
