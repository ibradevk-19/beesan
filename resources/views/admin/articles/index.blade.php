...
@section('content')
    <div class="container-fluid">
                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">المقالات الرائيسي</li>
                        </ol>
                    </div>
        ...
        <div class="row my-3">
            <div class="col-6">
                <a href="{{route('articles.create')}}"  class="btn btn-primary">مقال جديد</a>
            </div>
        </div>
        ...
        $(document).ready(function () {
            ...
            $("#datatable").DataTable({
                ...
                columns: [
                    ...
                    {data: 'title', name: 'title', title: 'العناون'},
                    {data: 'image', name: 'image' , title: 'الصورة', orderable: false, searchable: false},
                    {data: 'type', name: 'type' , title: 'النوع', orderable: false, searchable: false},
...
@include('includes.delete_item',['route_delete'=>url("/panel/articles")])
@endsection
