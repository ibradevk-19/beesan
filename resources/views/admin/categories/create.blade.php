            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-3">
                            <input class="form-control" placeholder="التصنيف " type="text" value="{{old('client_url')}}" name="name[ar]" id="example-text-input">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="example-text-input" class="col-md-2 col-form-label">التصنيف (الانجليزية )</label>
                        <div class="col-md-3">
                            <input class="form-control" placeholder="التصنيف " type="text" value="{{old('client_url')}}" name="name[en]" id="example-text-input">
                        </div>
                    </div>
