...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row my-3">
            <div class="col-6">
                <a href="{{route('categories.create')}}"  class="btn btn-primary">تصنيف جديد</a>
            </div>
        </div>
        ...
        $(document).ready(function () {
            ...
            $("#datatable").DataTable({
                ...
                columns: [
                    ...
                    {data: 'name', name: 'name', title: 'التصنيف'},
...
@include('includes.delete_item',['route_delete'=>url("/panel/categories")])
@endsection
