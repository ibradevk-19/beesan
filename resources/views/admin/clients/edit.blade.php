...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action=" {{route('clients.update', ['client' => $obj->id])}}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" placeholder="الرابط " type="text" value="{{$obj->client_url}}" name="client_url" id="example-text-input">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            ...
                            <input type="file" class="filestyle" onchange="showImage('image','image_thumbnail')" data-buttonname="btn-secondary" name="client_logo" id="image"
                                   data-buttonBefore="true"
                                   value="{{ (old('client_logo')) ? old('client_logo') : '' }}"
                    ...
                    <div class=""  id="image_thumbnail_show"  style="margin-right: 168px">
                        <img id="image_thumbnail" class="image_thumbnail" alt="200x200" style="width: 200px; height: 200px;"
                            src="{{$obj->client_logo}}" data-holder-rendered="true">
                    </div>
