...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row my-3">
            <div class="col-6">
                <a href="{{route('clients.create')}}"  class="btn btn-primary">شريك جديد</a>
            </div>
        </div>
        ...
        $(document).ready(function () {
            ...
            $("#datatable").DataTable({
                ...
                columns: [
                    ...
                    {data: 'client_url', name: 'client_url', title: 'الرابط'},
...
@include('includes.delete_item',['route_delete'=>url("/panel/clients")])
@endsection
