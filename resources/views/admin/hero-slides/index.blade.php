...
@section('content')
    <div class="container-fluid">
                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">سلايدر الرائيسي</li>
                        </ol>
                    </div>
        ...
        <div class="row my-3">
            <div class="col-6">
                <a href="{{route('hero-slide.create')}}"  class="btn btn-primary">سلايدر جديد</a>
            </div>
        </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#datatable").DataTable({
                ...
                serverSide: true,
                order: [[0, "desc" ]],
                ajax: "{{ route('hero-slide.index') }}",
                columns: [
                    {data: 'id', name: 'id', title: '#'},
                    {data: 'title_ar', name: 'title_ar', title: 'العناون'},
                    {data: 'url', name: 'url', title: 'الرابط'},
...
@include('includes.delete_item',['route_delete'=>url("/panel/hero-slide")])
@endsection
