            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">كشف المستفيد</h4>
                        <br/>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var columns_data = [
                    ...
                    {data: 'product_name', name: 'product_name', title: 'نوع المساعده',searchable: true},
                    {data: 'delivery_record', name: 'delivery_record', title: 'الدورة'},
                    {data: 'delivery_record_date', name: 'delivery_record_date', title: 'التاريخ'},
            ...
            $("#datatable").DataTable({
                ...
                ajax: "{{ route('admin.main.details', ['id' => $id]) }}",
