...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row my-3">
            <div class="col-6">
                <a href="{{route('projects.create')}}"  class="btn btn-primary">مشروع جديد</a>
            </div>
        </div>
        ...
        $(document).ready(function () {
            ...
            $("#datatable").DataTable({
                ...
                columns: [
                    ...
                    {data: 'title', name: 'title', title: 'العنوان'},
                    {data: 'client', name: 'client' , title: 'الشريك', orderable: false, searchable: false},
...
@include('includes.delete_item',['route_delete'=>url("/panel/projects")])
@endsection
