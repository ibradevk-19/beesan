...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row my-3">
            <div class="col-6">
                <a href="{{route('roles.create')}}"  class="btn btn-primary">صلاحية جديدة</a>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">قائمة الأذونات</h4>
                        <br/>
...
@section('scripts.center')
    ...
    <script>
        function  show_del_modal(id) {
         //    Get The modal With Data
         $.get('/panel/roles/' + id ).done(function(item) {


            $('#del_modal').replaceWith(item);
                $('#del_modal').modal("show");

                 // $item.print();
                //  $('#edit_model').replaceWith(item);
        ...
        $(document).ready(function () {
            ...
            $("#datatable").DataTable({
                ...
                columns: [
                    ...
                    {data: 'count_permission', name: 'count_permission', title: 'الصلاحيات',searchable:false},
                    {data: 'status_role', name: 'status_role' , title: 'الحالة',searchable:false},
...
<script>
 ...
 function delItemRequest(){
    var id = document.getElementById('id_value').value;
    var role_id = document.getElementById('role_id').value;

    axios.get('{{url("/panel/roles_del")}}?id='+id+'&role_id='+role_id )
