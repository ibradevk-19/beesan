        ...
        <nav id="navbar" class="navbar">
          <div class="container">
            <div class="navbar-inner-wrapper">
              ...
              <ul>
                <li>
                  <a class="navabr-link {{ request()->routeIs('home.index') ? 'active' : '' }}"
                ...
                <li>
                  <a class="navabr-link {{ request()->routeIs('home.news') ? 'active' : '' }}"
                ...
                <li>
                  <a class="navabr-link {{ request()->routeIs('home.about') ? 'active' : '' }}"
                ...
                <li>
                  <a class="navabr-link {{ request()->routeIs('home.sectors') ? 'active' : '' }}"
                ...
                <li>
                  <a class="navabr-link {{ request()->routeIs('home.projects') ? 'active' : '' }}"
                ...
                <li>
                  <a class="navabr-link {{ request()->routeIs('home.announcements') ? 'active' : '' }}"
                ...
                <li>
                  <a class="navabr-link {{ request()->routeIs('home.contact') ? 'active' : '' }}"
