          ...
          <div class="services-items" data-aos="fade-up" data-aos-delay="150">
            <div class="services-slider slider">
                ...
                <div class="row gy-4 " id="articles-container">
                  @include('frontend.articles.partials.project-items', ['projects' => $projects])
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-6">
              <div class="services-bottom-content">
                <h2
                  ...
                  data-aos-delay="150"
                >
                   {{ $settings->TranslatedProjectsTitle }}
                </h2>
                <p data-aos="fade-up" data-aos-delay="200">
                    {{ Str::words(strip_tags($settings->TranslatedProjectsBody), 500, '...') }}
                </p>
              </div>
            </div>
            <div class="col-lg-6">
              ...
              >
                <img
                  class="img-full"
                  src="{{ asset('storage/' . $settings['projects_image']) }}"
                  alt="{{ $settings->TranslatedProjectsTitle }}   "
                />
              </div>
            </div>
          </div>
